...
### Syntax Coloring
Syntax coloring in VSCode uses Text-Mate grammers. However, for easier maintainability we wanted to use our Tree-Sitter parsers for the syntax coloring, instead of having to maintain 2 different grammers.
