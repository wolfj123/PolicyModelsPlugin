...
describe('Definition test Policy Space', () => {
	...
	it('HumanDataType Test' + testCounter.toString(), async () => {
		let testSelectionRange: vscode.Range = getWordRangeFromLineInEditor("HumanDataType", 1);
		let position : vscode.Position = getWordPositionFromLine("HumanDataType", 1);
		let resultRange: vscode.Range = getWordRangeFromLineInEditor("HumanDataType", 0);
	...
	it('Harm Test' + testCounter.toString(), async () => {
		let testSelectionRange: vscode.Range = getWordRangeFromLineInEditor("Harm", 2);
		let position : vscode.Position = getWordPositionFromLine("Harm", 2);
		let resultRange: vscode.Range = getWordRangeFromLineInEditor("Harm", 0);
	...
	it('Encryption Test' + testCounter.toString(), async () => {
		let testSelectionRange: vscode.Range = getWordRangeFromLineInEditor("Encryption", 3);
		let position : vscode.Position = getWordPositionFromLine("Encryption", 3);
		let resultRange: vscode.Range = getWordRangeFromLineInEditor("Encryption", 0);
